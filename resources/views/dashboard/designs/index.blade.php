...
@section('container')
    ...
    <div class="d-flex flex-column justify-content-between" style="height: 80dvh;">
        {{-- Designs Table --}}
                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody>
                        @foreach ($designs as $design)
                            <tr>
                                <td>{{ $loop->iteration + ($designs->currentPage() - 1) * $designs->perPage() }}</td>
                                <td>{{ $design->title }}</td>
                                <td>
                                    @php
        ...
        {{-- Paginate Links --}}
        <div class="col-lg-10 d-flex justify-content-center align-items-center mt-auto">
            {{ $designs->links() }}
        </div>
